...
import { Client, TaskDay } from '../../interfaces';
import { HourPipe } from '../../pipes';
...
export class ClientStatisticComponent implements OnInit {
  ...
  allTasks$: Observable<TaskDay[]> | undefined;
  ...
  fromFormat: Date | undefined;
  toFormat: Date | undefined;

  nickName: string | undefined;
  imageSrc: string | undefined;
  bsRangeValue: Date[] | undefined;

  PDFdataArray: any[] | undefined;
  ...
  //         .reduce((acc: any, cur: { wastedTime: any; }) => {
  //           return acc + cur.wastedTime;
  //         }, 0)
  //         .toFixed(2);

  //         if(this.client){
  //           const tarif = this.client.tarif ? this.client.tarif : 0;

  //           this.totalPayment = Math.round(this.totalHours / 60) * tarif;
  //         }
  //     }),
  //     map(res => {
